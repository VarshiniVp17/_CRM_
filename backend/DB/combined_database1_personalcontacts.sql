...
CREATE TABLE `personalcontacts` (
  ...
  `reportingManager` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  ...
  `mobileNo` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `personalcontacts`
--

LOCK TABLES `personalcontacts` WRITE;
/*!40000 ALTER TABLE `personalcontacts` DISABLE KEYS */;
INSERT INTO `personalcontacts` VALUES (1,'P','Pallavi','P Pallavi','Jai Shankar','IT','Testing','Developer','KK Nagar ','Chennai','TN','IN','600053','pallavi@gmail.com','9388393302'),(2,'P','Pallavi','P Pallavi','JaiShankar','CIS','Programmer Trainee','testing','Ambattur','Chennai','TN','IN','600053','pallavi@gmail.com','74848292022');
/*!40000 ALTER TABLE `personalcontacts` ENABLE KEYS */;
UNLOCK TABLES;
